...
start "Flask Backend Server" cmd /k "cd /d "%SCRIPT_DIR%backend" && uvicorn main:app --reload --port 4000 && echo. && echo Backend uruchomiony. Nacisnij dowolny klawisz, aby kontynuowac... && pause"
...
start "Frontend Server" cmd /k "cd /d "%SCRIPT_DIR%frontend" && npm run dev && echo. && echo Frontend uruchomiony. Nacisnij dowolny klawisz, aby kontynuowac... && pause"
